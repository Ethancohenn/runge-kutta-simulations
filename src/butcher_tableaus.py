"""
Definition of Butcher tableaus (A, B, C) for the RK methods studied.

"""

import numpy as np

# Stage coefficient matrices A (Adict[method][i,j] == a_{ij})
Adict = {
    "Euler-Heun": np.array([
        [0,   0],
        [1,   0]
    ]),
    "Dormand-Prince": np.array([
        [0,            0,          0,          0,         0,         0, 0],
        [1/5,          0,          0,          0,         0,         0, 0],
        [3/40,         9/40,       0,          0,         0,         0, 0],
...
# Weights B for embedded pairs or final combination
Bdict = {
    "Euler-Heun": np.array([
        [1/2, 1/2],
        [1,   0]
